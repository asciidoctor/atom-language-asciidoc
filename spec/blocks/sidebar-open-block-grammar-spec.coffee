describe 'Sidebar open block', ->
  ...
  describe 'Should not tokenizes when', ->
    ...
    it 'beginning with space', ->
      ...
      expect(tokens[1]).toHaveLength 1
      expect(tokens[1][0]).toEqualJson value: '--', scopes: ['source.asciidoc', 'markup.block.open.asciidoc', 'constant.other.symbol.asciidoc']
      expect(tokens[2]).toHaveLength 5
      expect(tokens[2][0]).toEqualJson value: 'A multi-line ', scopes: ['source.asciidoc', 'markup.block.open.asciidoc']
      expect(tokens[2][1]).toEqualJson value: '*', scopes: ['source.asciidoc', 'markup.block.open.asciidoc', 'markup.strong.constrained.asciidoc', 'markup.bold.asciidoc', 'punctuation.definition.asciidoc']
      expect(tokens[2][2]).toEqualJson value: 'sidebar', scopes: ['source.asciidoc', 'markup.block.open.asciidoc', 'markup.strong.constrained.asciidoc', 'markup.bold.asciidoc']
      expect(tokens[2][3]).toEqualJson value: '*', scopes: ['source.asciidoc', 'markup.block.open.asciidoc', 'markup.strong.constrained.asciidoc', 'markup.bold.asciidoc', 'punctuation.definition.asciidoc']
      expect(tokens[2][4]).toEqualJson value: '.', scopes: ['source.asciidoc', 'markup.block.open.asciidoc']
      expect(tokens[3]).toHaveLength 1
      expect(tokens[3][0]).toEqualJson value: '--', scopes: ['source.asciidoc', 'markup.block.open.asciidoc', 'constant.other.symbol.asciidoc']
