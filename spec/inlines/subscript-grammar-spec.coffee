describe 'Should tokenizes subscript when', ->
  ...
  it 'simple phrase', ->
    ...
    expect(tokens[0]).toEqualJson value: '~', scopes: ['source.asciidoc', 'markup.subscript.asciidoc', 'markup.sub.subscript.asciidoc', 'punctuation.definition.sub.asciidoc']
    ...
    expect(tokens[2]).toEqualJson value: '~', scopes: ['source.asciidoc', 'markup.subscript.asciidoc', 'markup.sub.subscript.asciidoc', 'punctuation.definition.sub.asciidoc']
