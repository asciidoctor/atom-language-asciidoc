describe '`monospace`', ->
  ...
  describe 'Should tokenizes constrained `monospace` when', ->
    ...
    it 'is in a phrase', ->
      ...
      expect(tokens[0]).toEqualJson value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      ...
      expect(tokens[2]).toEqualJson value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      expect(tokens[3]).toEqualJson value: ' renders exactly as entered, in ', scopes: ['source.asciidoc']
      expect(tokens[4]).toEqualJson value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      ...
      expect(tokens[6]).toEqualJson value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
    ...
    it 'when having a [role] set on constrained `monospace` text', ->
      ...
      expect(tokens[1]).toEqualJson value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      ...
      expect(tokens[3]).toEqualJson value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
  ...
  describe 'Should tokenizes unconstrained `monospace` when', ->
    ...
    it 'is in a phrase', ->
      ...
      expect(tokens[1]).toEqualJson value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      ...
      expect(tokens[3]).toEqualJson value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      expect(tokens[4]).toEqualJson value: ' renders exactly as entered, in mono', scopes: ['source.asciidoc']
      expect(tokens[5]).toEqualJson value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
      ...
      expect(tokens[7]).toEqualJson value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'markup.raw.monospace.asciidoc', 'punctuation.definition.raw.asciidoc']
