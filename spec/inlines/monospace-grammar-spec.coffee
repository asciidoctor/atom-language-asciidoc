describe '`monospace`', ->
  ...
  describe 'Should tokenizes constrained `monospace` when', ->
    ...
    it 'is in a phrase', ->
      ...
      expect(tokens[0]).toEqual value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[2]).toEqual value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[3]).toEqual value: ' renders exactly as entered, in ', scopes: ['source.asciidoc']
      expect(tokens[4]).toEqual value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[6]).toEqual value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'when having a [role] set on constrained `monospace` text', ->
      ...
      expect(tokens[1]).toEqual value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[3]).toEqual value: '`', scopes: ['source.asciidoc', 'markup.monospace.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
  ...
  describe 'Should tokenizes unconstrained `monospace` when', ->
    ...
    it 'is in a phrase', ->
      ...
      expect(tokens[1]).toEqual value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[3]).toEqual value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[4]).toEqual value: ' renders exactly as entered, in mono', scopes: ['source.asciidoc']
      expect(tokens[5]).toEqual value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[7]).toEqual value: '``', scopes: ['source.asciidoc', 'markup.monospace.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
