describe 'Should tokenizes superscript when', ->
  ...
  it 'simple phrase', ->
    ...
    expect(tokens[0]).toEqual value: '^', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[1]).toEqual value: 'superscript', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'markup.super.superscript.asciidoc']
    expect(tokens[2]).toEqual value: '^', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'punctuation.definition.entity.asciidoc']
  ...
  it 'when having a [role] set on ^superscript^ text', ->
    ...
    expect(tokens[1]).toEqual value: '^', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[3]).toEqual value: '^', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'punctuation.definition.entity.asciidoc']
