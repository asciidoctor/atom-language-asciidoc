describe 'Should tokenizes quote block when', ->
  ...
  it 'with Markdown style and mix content', ->
    ...
    expect(tokens[2][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.italic.quotes.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[2][2]).toEqual value: 'strong', scopes: ['source.asciidoc', 'markup.italic.quotes.asciidoc', 'markup.strong.constrained.asciidoc', 'markup.bold.strong.asciidoc']
    expect(tokens[2][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.italic.quotes.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[3]).toHaveLength 1
