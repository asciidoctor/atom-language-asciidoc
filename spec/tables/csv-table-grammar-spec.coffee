describe 'Should tokenizes CSV table when', ->
  ...
  it 'contains several lines', ->
    ...
    expect(tokens[1][1]).toEqualJson value: ',', scopes: ['source.asciidoc', 'markup.table.csv.asciidoc', 'string.unquoted.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    expect(tokens[1][2]).toEqualJson value: 'Track', scopes: ['source.asciidoc', 'markup.table.csv.asciidoc', 'string.unquoted.asciidoc']
    expect(tokens[1][3]).toEqualJson value: ',', scopes: ['source.asciidoc', 'markup.table.csv.asciidoc', 'string.unquoted.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[3][1]).toEqualJson value: ',', scopes: ['source.asciidoc', 'markup.table.csv.asciidoc', 'string.unquoted.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    expect(tokens[3][2]).toEqualJson value: 'Stinkfist', scopes: ['source.asciidoc', 'markup.table.csv.asciidoc', 'string.unquoted.asciidoc']
    expect(tokens[3][3]).toEqualJson value: ',', scopes: ['source.asciidoc', 'markup.table.csv.asciidoc', 'string.unquoted.asciidoc', 'markup.table.delimiter.cell.asciidoc']
