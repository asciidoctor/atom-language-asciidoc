describe 'AsciiDoc grammar', ->
  ...
  describe 'Should tokenizes code block when', ->
    ...
    it 'is followed by others grammar parts', ->
      ...
      expect(tokens[5][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.bold.constrained.asciidoc', 'support.constant.asciidoc']
      expect(tokens[5][2]).toEqual value: 'Grammars', scopes: ['source.asciidoc', 'markup.bold.constrained.asciidoc']
      expect(tokens[5][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.bold.constrained.asciidoc', 'support.constant.asciidoc']
      ...
      expect(tokens[6][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.bold.constrained.asciidoc', 'support.constant.asciidoc']
      expect(tokens[6][2]).toEqual value: 'CoffeeLint', scopes: ['source.asciidoc', 'markup.bold.constrained.asciidoc']
      expect(tokens[6][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.bold.constrained.asciidoc', 'support.constant.asciidoc']
