describe 'Should tokenizes DSV table when', ->
  grammar = null
  ...
  it 'contains several lines', ->
    ...
    expect(tokens[0][0]).toEqualJson value: ':===', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'constant.other.symbol.asciidoc']
    ...
    expect(tokens[1][1]).toEqualJson value: ':', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'string.unquoted.asciidoc', 'constant.other.symbol.asciidoc']
    expect(tokens[1][2]).toEqualJson value: 'Track', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'string.unquoted.asciidoc']
    expect(tokens[1][3]).toEqualJson value: ':', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'string.unquoted.asciidoc', 'constant.other.symbol.asciidoc']
    ...
    expect(tokens[3][1]).toEqualJson value: ':', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'string.unquoted.asciidoc', 'constant.other.symbol.asciidoc']
    expect(tokens[3][2]).toEqualJson value: 'Stinkfist', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'string.unquoted.asciidoc']
    expect(tokens[3][3]).toEqualJson value: ':', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'string.unquoted.asciidoc', 'constant.other.symbol.asciidoc']
    ...
    expect(tokens[4][0]).toEqualJson value: ':===', scopes: ['source.asciidoc', 'markup.table.dsv.asciidoc', 'constant.other.symbol.asciidoc']
