describe 'Should tokenizes example block when', ->
  ...
  it 'contains others grammars', ->
    ...
    expect(tokens[1][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.bold.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[1][2]).toEqual value: 'example', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.bold.strong.constrained.asciidoc']
    expect(tokens[1][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.bold.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[3][1]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.italic.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[3][3]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.italic.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
