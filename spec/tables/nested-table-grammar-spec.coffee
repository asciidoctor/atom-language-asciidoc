describe 'Should tokenizes nested table when', ->
  ...
  it 'contains several lines', ->
    ...
    expect(tokens[1][1]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[1][4]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    expect(tokens[1][5]).toEqualJson value: '2   ', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc']
    expect(tokens[1][6]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    expect(tokens[1][7]).toEqualJson value: '3        ', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc']
    expect(tokens[1][8]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[2][1]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[2][4]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[2][7]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[3][1]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[4][1]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
    ...
    expect(tokens[4][4]).toEqualJson value: '!', scopes: ['source.asciidoc', 'markup.table.nested.asciidoc', 'markup.table.content.asciidoc', 'markup.table.delimiter.cell.asciidoc']
