describe 'Should tokenizes code block when', ->
  ...
  it 'is followed by others grammar parts', ->
    ...
    expect(tokens[5][4]).toEqualJson value: '*', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[5][6]).toEqualJson value: '*', scopes: [ 'source.asciidoc', 'callout.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[5][7]).toEqualJson value: ' ', scopes: ['source.asciidoc', 'callout.asciidoc']
    expect(tokens[5][8]).toEqualJson value: '_', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[5][10]).toEqualJson value: '_', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[5]).toHaveLength 11
    ...
    expect(tokens[6][4]).toEqualJson value: '*', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[6][6]).toEqualJson value: '*', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[6][7]).toEqualJson value: ' ', scopes: ['source.asciidoc', 'callout.asciidoc']
    expect(tokens[6][8]).toEqualJson value: '_', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[6][10]).toEqualJson value: '_', scopes: ['source.asciidoc', 'callout.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
