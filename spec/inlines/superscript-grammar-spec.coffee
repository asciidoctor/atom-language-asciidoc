describe 'Should tokenizes superscript when', ->
  ...
  it 'simple phrase', ->
    ...
    expect(tokens[0]).toEqual value: '^', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'punctuation.definition.super.asciidoc']
    ...
    expect(tokens[2]).toEqual value: '^', scopes: ['source.asciidoc', 'markup.superscript.asciidoc', 'punctuation.definition.super.asciidoc']
