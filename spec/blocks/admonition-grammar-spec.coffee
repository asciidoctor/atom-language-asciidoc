describe 'Should tokenizes admonition when', ->
  ...
  it 'start with NOTE:', ->
    ...
    expect(tokens[0]).toEqualJson value: 'NOTE:', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'support.constant.label.asciidoc']
  ...
  it 'start with NOTE: and have several lines', ->
    ...
    expect(tokens[2][0]).toEqualJson value: 'NOTE:', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'support.constant.label.asciidoc']
  ...
  it 'start with TIP:', ->
    ...
    expect(tokens).toHaveLength 3
    expect(tokens[0]).toEqualJson value: 'TIP:', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'support.constant.label.asciidoc']
    expect(tokens[1]).toEqualJson value: ' ', scopes: ['source.asciidoc', 'markup.admonition.asciidoc']
  ...
  it 'start with IMPORTANT:', ->
    ...
    expect(tokens).toHaveLength 3
    expect(tokens[0]).toEqualJson value: 'IMPORTANT:', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'support.constant.label.asciidoc']
    expect(tokens[1]).toEqualJson value: ' ', scopes: ['source.asciidoc', 'markup.admonition.asciidoc']
  ...
  it 'start with WARNING:', ->
    ...
    expect(tokens).toHaveLength 3
    expect(tokens[0]).toEqualJson value: 'WARNING:', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'support.constant.label.asciidoc']
    expect(tokens[1]).toEqualJson value: ' ', scopes: ['source.asciidoc', 'markup.admonition.asciidoc']
  ...
  it 'start with CAUTION:', ->
    ...
    expect(tokens).toHaveLength 3
    expect(tokens[0]).toEqualJson value: 'CAUTION:', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'support.constant.label.asciidoc']
    expect(tokens[1]).toEqualJson value: ' ', scopes: ['source.asciidoc', 'markup.admonition.asciidoc']
