describe 'Should tokenizes anchor macro when', ->
  ...
  it 'simple anchor', ->
    ...
    expect(tokens[1]).toEqual value: '[[', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[2]).toEqual value: 'idname', scopes: ['source.asciidoc', 'markup.blockid.asciidoc']
    expect(tokens[3]).toEqual value: ']]', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
  ...
  it 'extends anchor', ->
    ...
    expect(tokens[4]).toEqual value: ']]', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
  ...
  it 'simple anchor macro', ->
    ...
    expect(tokens).toHaveLength 6
    expect(tokens[0]).toEqual value: 'foo ', scopes: ['source.asciidoc']
    expect(tokens[1]).toEqual value: 'anchor:', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[2]).toEqual value: 'idname', scopes: ['source.asciidoc', 'markup.blockid.asciidoc']
    expect(tokens[3]).toEqual value: '[', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[4]).toEqual value: ']', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[5]).toEqual value: ' bar', scopes: ['source.asciidoc']
  ...
  it 'extends anchor macro', ->
    ...
    expect(tokens[2]).toEqual value: 'idname', scopes: ['source.asciidoc', 'markup.blockid.asciidoc']
    expect(tokens[3]).toEqual value: '[', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[4]).toEqual value: 'Reference Text', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[5]).toEqual value: ']', scopes: ['source.asciidoc', 'punctuation.definition.entity.asciidoc']
