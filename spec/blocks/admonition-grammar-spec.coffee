describe 'Should tokenizes admonition when', ->
  ...
  it 'start with NOTE: and have several lines', ->
    ...
    expect(tokens[4][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[4][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[5][1]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[5][3]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.admonition.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
