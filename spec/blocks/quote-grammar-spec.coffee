describe 'Should tokenizes quote block when', ->
  ...
  it 'with Markdown style and mix content', ->
    ...
    expect(tokens[2][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.italic.quotes.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.bold.asciidoc']
    ...
    expect(tokens[2][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.italic.quotes.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.bold.asciidoc']
    expect(tokens[3]).toHaveLength 1
