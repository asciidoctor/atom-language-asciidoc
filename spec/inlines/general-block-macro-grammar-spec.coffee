describe 'Should tokenizes general block macro when', ->
  ...
  it 'reference a gist', ->
    ...
    expect(tokens[0]).toEqual value: 'gist::', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[1]).toEqual value: '123456', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc']
    expect(tokens[2]).toEqual value: '[', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc', 'punctuation.definition.entity.asciidoc']
    expect(tokens[3]).toEqual value: ']', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc', 'punctuation.definition.entity.asciidoc']

  it 'reference an image', ->
    {tokens} = grammar.tokenizeLine 'image::filename.png[Caption]'
    expect(tokens).toHaveLength 5
    expect(tokens[0]).toEqual value: 'image::', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[4]).toEqual value: ']', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc', 'punctuation.definition.entity.asciidoc']

  it 'reference a video', ->
    {tokens} = grammar.tokenizeLine 'video::http://youtube.com/12345[Cats vs Dogs]'
    expect(tokens).toHaveLength 5
    expect(tokens[0]).toEqual value: 'video::', scopes: ['source.asciidoc', 'markup.macro.block.general.asciidoc', 'punctuation.definition.entity.asciidoc']
