...
A general introduction into writing a syntax highlighting package: http://www.sitepoint.com/how-to-write-a-syntax-highlighting-package-for-atom/[how to write a syntax highlighting package for Atom]
...
Atom uses the https://github.com/kkos/oniguruma[Oniguruma] library for parsing regular expressions.
The https://github.com/kkos/oniguruma/blob/master/doc/RE[documentation] provides an overview of supported elements.

Generally it can be said that POSIX-style regex elements are preferred (`/p{blank}`, `\p{word}`) as they better support internationalization.
