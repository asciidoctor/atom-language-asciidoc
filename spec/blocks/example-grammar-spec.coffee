describe 'Should tokenizes example block when', ->
  ...
  it 'contains others grammars', ->
    ...
    expect(tokens[1][1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[1][3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[3][1]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    expect(tokens[3][3]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.block.example.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
