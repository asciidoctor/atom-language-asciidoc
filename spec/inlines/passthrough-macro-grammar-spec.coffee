describe 'Should tokenizes passthrough macro when', ->
  ...
  it 'as attribute, started at the beginning of the line and without text after.', ->
    ...
    expect(tokens[0]).toEqualJson value: 'pass:', scopes: ['source.asciidoc', 'markup.macro.inline.passthrough.asciidoc']
    ...
    expect(tokens[3]).toEqualJson value: '<u>underline *me*</u>', scopes: ['source.asciidoc', 'markup.macro.inline.passthrough.asciidoc', 'markup.raw.asciidoc']
  ...
  it 'as attribute, in a phrase.', ->
    ...
    expect(tokens[1]).toEqualJson value: 'pass:', scopes: ['source.asciidoc', 'markup.macro.inline.passthrough.asciidoc']
    ...
    expect(tokens[4]).toEqualJson value: '<u>underline *me*</u>', scopes: ['source.asciidoc', 'markup.macro.inline.passthrough.asciidoc', 'markup.raw.asciidoc']
  ...
  it 'as triple-plus, in a phrase.', ->
    ...
    expect(tokens[2]).toEqualJson value: '<u>underline *me*</u>', scopes: ['source.asciidoc', 'markup.macro.inline.passthrough.asciidoc', 'markup.raw.asciidoc']
