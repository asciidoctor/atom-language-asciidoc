describe '*strong* text', ->
  ...
  describe 'Should tokenizes constrained *strong* text', ->
    ...
    it 'when constrained *strong* text', ->
      ...
      expect(tokens[1]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[3]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'when constrained *strong* at the beginning of the line', ->
      ...
      expect(tokens[0]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[2]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'when constrained *strong* in a * bulleted list', ->
      ...
      expect(tokens[4]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'when constrained *strong* text within special characters', ->
      ...
      expect(tokens[5]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[7]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[8]).toEqual value: ':, .', scopes: ['source.asciidoc']
      expect(tokens[9]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[11]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[12]).toEqual value: '; ,', scopes: ['source.asciidoc']
      expect(tokens[13]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[15]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'when text is "*strong* text *strong* text"', ->
      ...
      expect(tokens[6]).toEqual value: '*', scopes: ['source.asciidoc', 'markup.strong.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
  ...
  describe 'Should tokenizes unconstrained s**t**rong text', ->
    ...
    it 'when unconstrained **strong** text', ->
      {tokens} = grammar.tokenizeLine 'this is**strong**text'
      expect(tokens[0]).toEqual value: 'this is', scopes: ['source.asciidoc']
      expect(tokens[1]).toEqual value: '**', scopes: ['source.asciidoc', 'markup.strong.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[3]).toEqual value: '**', scopes: ['source.asciidoc', 'markup.strong.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[4]).toEqual value: 'text', scopes: ['source.asciidoc']
