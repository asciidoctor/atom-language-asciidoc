describe '_emphasis_ text', ->
  ...
  describe 'Should tokenizes constrained _emphasis_ text when', ->
    ...
    it 'is in a phrase', ->
      ...
      expect(tokens[1]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[3]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'tokenizes _emphasis_ text at the beginning of the line', ->
      ...
      expect(tokens[0]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[2]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'tokenizes _emphasis_ text in a * bulleted list', ->
      ...
      expect(tokens[4]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
    ...
    it 'tokenizes constrained _emphasis_ text within special characters', ->
      ...
      expect(tokens[5]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[7]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[8]).toEqual value: ':, .', scopes: ['source.asciidoc']
      expect(tokens[9]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[11]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[12]).toEqual value: '; ,', scopes: ['source.asciidoc']
      expect(tokens[13]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[15]).toEqual value: '_', scopes: ['source.asciidoc', 'markup.emphasis.constrained.asciidoc', 'punctuation.definition.entity.asciidoc']
  ...
  describe 'Should tokenizes unconstrained __emphasis__ text when', ->
    ...
    it 'tokenizes __emphasis__ text', ->
      ...
      expect(tokens).toHaveLength 5
      expect(tokens[0]).toEqual value: 'this is', scopes: ['source.asciidoc']
      expect(tokens[1]).toEqual value: '__', scopes: ['source.asciidoc', 'markup.emphasis.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      ...
      expect(tokens[3]).toEqual value: '__', scopes: ['source.asciidoc', 'markup.emphasis.unconstrained.asciidoc', 'punctuation.definition.entity.asciidoc']
      expect(tokens[4]).toEqual value: 'text', scopes: ['source.asciidoc']
